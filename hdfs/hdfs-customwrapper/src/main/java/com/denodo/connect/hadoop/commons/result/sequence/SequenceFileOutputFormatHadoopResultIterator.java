 ...
 * 
 */
public class SequenceFileOutputFormatHadoopResultIterator implements IHadoopResultIterator {

    private static final Logger logger = Logger.getLogger(SequenceFileOutputFormatHadoopResultIterator.class);
    ...
    public SequenceFileOutputFormatHadoopResultIterator(String dataNodeIp, String dataNodePort, String hadoopKeyClass,
            String hadoopValueClass, Path outputPath, boolean deleteOutputPathAfterReadOutput) {
        super();
    ...
    public <K extends Writable, V extends Writable> boolean readNext(K key, V value) {
        try {
            ...
            if (this.currentReader == null) {
                ...
                this.currentReader = new SequenceFile.Reader(this.fileSystem, this.fss[this.currentFileStatusIndex].getPath(),
                        this.configuration);
            }
