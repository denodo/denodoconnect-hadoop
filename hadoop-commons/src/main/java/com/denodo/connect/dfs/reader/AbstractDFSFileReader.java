...
import com.denodo.connect.dfs.util.io.FileFilter;

public abstract class AbstractDFSFileReader implements DFSFileReader {

    private static final  Logger LOG = LoggerFactory.getLogger(AbstractDFSFileReader.class);
    ...
    public AbstractDFSFileReader(final Configuration configuration, final Path outputPath, final String fileNamePattern, final String user, final boolean includePathColumn)
