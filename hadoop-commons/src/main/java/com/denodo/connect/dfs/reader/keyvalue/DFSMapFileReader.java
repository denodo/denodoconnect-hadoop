 ...
 *
 */
public class DFSMapFileReader extends AbstractDFSKeyValueFileReader {


    private MapFile.Reader currentReader;

    public DFSMapFileReader(final Configuration configuration, final String hadoopKeyClass, final String hadoopValueClass,
