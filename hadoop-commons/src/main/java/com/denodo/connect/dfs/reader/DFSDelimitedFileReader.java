...
import com.denodo.connect.dfs.util.csv.CSVReader;

/**
 * Class to iterate over a Delimited Text File.
 *
 */
public class DFSDelimitedFileReader extends AbstractDFSFileReader {
    ...
    public DFSDelimitedFileReader(final Configuration configuration, final CSVConfig cvsConfig,
