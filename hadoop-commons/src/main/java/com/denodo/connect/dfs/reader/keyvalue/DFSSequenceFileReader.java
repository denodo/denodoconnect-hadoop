 ...
 *
 */
public class DFSSequenceFileReader extends AbstractDFSKeyValueFileReader {


    private SequenceFile.Reader currentReader;

    public DFSSequenceFileReader(final Configuration configuration, final String hadoopKeyClass,
