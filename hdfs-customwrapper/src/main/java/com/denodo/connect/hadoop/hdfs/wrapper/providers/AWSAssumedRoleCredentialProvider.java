...
import static com.denodo.connect.hadoop.hdfs.wrapper.providers.Constants.ASSUMED_ROLE_ARN;
import static com.denodo.connect.hadoop.hdfs.wrapper.providers.Constants.ASSUMED_ROLE_CREDENTIALS_PROVIDER;
import static com.denodo.connect.hadoop.hdfs.wrapper.providers.Constants.ASSUMED_ROLE_POLICY;
import static com.denodo.connect.hadoop.hdfs.wrapper.providers.Constants.ASSUMED_ROLE_SESSION_DURATION;
import static com.denodo.connect.hadoop.hdfs.wrapper.providers.Constants.ASSUMED_ROLE_SESSION_DURATION_DEFAULT;
import static com.denodo.connect.hadoop.hdfs.wrapper.providers.Constants.ASSUMED_ROLE_SESSION_NAME;
import static com.denodo.connect.hadoop.hdfs.wrapper.providers.Constants.ASSUMED_ROLE_STS_ENDPOINT;
...
public class AWSAssumedRoleCredentialProvider implements AWSCredentialsProvider,
    Closeable {
     ...
     */
    public AWSAssumedRoleCredentialProvider(Configuration conf) throws IOException {
        ...
        Class<?>[] awsClasses = S3AUtils.loadAWSProviderClasses(conf,
            ASSUMED_ROLE_CREDENTIALS_PROVIDER,
        ...
        for (Class<?> aClass : awsClasses) {
            ...
            credentials.add(S3AUtils.createAWSCredentialProvider(conf, aClass));
        }
