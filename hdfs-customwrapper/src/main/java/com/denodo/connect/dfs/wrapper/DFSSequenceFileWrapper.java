...
import com.denodo.connect.dfs.reader.keyvalue.DFSSequenceFileReader;
...
/**
 * DFS file custom Wrapper for reading sequence files stored in a DFS (Distributed File System: hdfs, S3...).
 * <p>
 *
 ...
 *
 */
public class DFSSequenceFileWrapper extends AbstractDFSKeyValueFileWrapper {
    ...
    public DFSFileReader getDFSFileReader(final Map<String, String> inputValues, final boolean getSchemaParameters)
        ...
        return new DFSSequenceFileReader(conf, hadoopKeyClass, hadoopValueClass, path, fileNamePattern, null, includePathColumn && !getSchemaParameters);
    }
