...
import static com.denodo.connect.dfs.commons.naming.Parameter.AUTOMATIC_PARALLELISM;
import static com.denodo.connect.dfs.commons.naming.Parameter.CLUSTER_PARTITION_FIELDS;
import static com.denodo.connect.dfs.commons.naming.Parameter.COLUMN_PARALLEL;
import static com.denodo.connect.dfs.commons.naming.Parameter.FILESYSTEM_URI;
import static com.denodo.connect.dfs.commons.naming.Parameter.FILE_NAME_PATTERN;
import static com.denodo.connect.dfs.commons.naming.Parameter.FILE_PARALLEL;
import static com.denodo.connect.dfs.commons.naming.Parameter.INCLUDE_PATH_COLUMN;
import static com.denodo.connect.dfs.commons.naming.Parameter.NOT_PARALLEL;
import static com.denodo.connect.dfs.commons.naming.Parameter.PARALLELISM_LEVEL;
import static com.denodo.connect.dfs.commons.naming.Parameter.PARALLELISM_TYPE;
import static com.denodo.connect.dfs.commons.naming.Parameter.PARQUET_FILE_PATH;
import static com.denodo.connect.dfs.commons.naming.Parameter.ROW_PARALLEL;
import static com.denodo.connect.dfs.commons.naming.Parameter.THREADPOOL_SIZE;
...
import com.denodo.connect.dfs.wrapper.concurrent.strategy.AutomaticReadingStrategy;
import com.denodo.connect.dfs.wrapper.concurrent.strategy.ColumnReadingStrategy;
import com.denodo.connect.dfs.wrapper.concurrent.strategy.FileReadingStrategy;
import com.denodo.connect.dfs.wrapper.concurrent.strategy.NonConcurrentReadingStrategy;
import com.denodo.connect.dfs.wrapper.concurrent.strategy.ReadingStrategy;
import com.denodo.connect.dfs.wrapper.concurrent.strategy.RowGroupReadingStrategy;
...
/**
 * DFS file custom wrapper for reading Parquet files stored in a DFS (Distributed File System: hdfs, S3, ...).
 *
 */
public class DFSParquetFileWrapper extends AbstractSecureWrapper {

    private static final  Logger LOG = LoggerFactory.getLogger(DFSParquetFileWrapper.class);
