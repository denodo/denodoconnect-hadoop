 ...
 * =============================================================================
 */
package com.denodo.connect.hadoop.mapreduce.wrapper.commons.handler.map;
...
import com.denodo.connect.hadoop.mapreduce.wrapper.commons.output.map.MapFileReader;

/**
 * Abstract handler to work with {@link MapFile} It implements the
 * getOutputReader method
 *
 */
public abstract class AbstractMapFileOutputMapReduceTaskHandler implements
    IMapReduceTaskHandler {
    ...
    public IMapReduceTaskOutputReader getOutputReader(String hostIp,
        ...
        return new MapFileReader(dataNodeIP, dataNodePort, hadoopKeyClass,
